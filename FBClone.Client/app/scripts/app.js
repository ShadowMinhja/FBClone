...
angular
  ...
  .run(['$rootScope', '$state', '$stateParams', 'currentUser', function ($rootScope, $state, $stateParams, currentUser) {
    ...
    var authorizedStates = ['app.dashboard', 'core.login', 'core.signup'];
  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    .state('app.admin', {
        ...
        url: '/admin',
        controller: 'MailCtrl',
        templateUrl: 'views/tmpl/admin/admin.html'
    })
    //admin/survey
    .state('app.admin.survey', {
        url: '/survey',
        //controller: 'SurveyCtrl',
        templateUrl: 'views/tmpl/admin/survey.html'
    })
    //admin/staff
    .state('app.admin.staff', {
        url: '/staff',
        //controller: 'StaffCtrl',
        templateUrl: 'views/tmpl/admin/staff.html'
    })
    //admin/branding
    .state('app.admin.branding', {
        url: '/branding',
        controller: 'BrandingCtrl',
        templateUrl: 'views/tmpl/admin/branding.html'
    })
    //admin/promotions
    .state('app.admin.promotions', {
        url: '/promotions',
        controller: 'PromotionsCtrl',
        templateUrl: 'views/tmpl/admin/promotions.html'
    })
    //admin/locations
    .state('app.admin.locations', {
        url: '/locations',
        //controller: 'LocationsCtrl',
        templateUrl: 'views/tmpl/admin/locations.html'
    })
    //mail
    .state('app.mail', {
      abstract: true,
    ...
    .state('core.signup', {
      url: '/signup',
      templateUrl: 'views/tmpl/login/signup.html'
    })
    //forgot password
    .state('core.forgotpass', {
      url: '/forgotpass',
      controller: 'ForgotPasswordCtrl',
      templateUrl: 'views/tmpl/login/forgotpass.html'
    })
    //page 404
    .state('core.page404', {
      url: '/page404',
