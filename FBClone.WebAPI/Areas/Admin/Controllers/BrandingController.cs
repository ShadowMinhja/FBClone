...
namespace FBClone.WebAPI.Areas.Admin.Controllers
{
    ...
    public class BrandingController : BaseController
    {
        ...
        public BrandingController(IBlobStorageService blobStorageStore, IApplicationSettingService applicationSettingService) {
        ...
        public IHttpActionResult Get()
        {
            ...
            try {
                imagePath = this.blobStorageStore.GetBrandingImagePath(userId,
                        ...
                        ConfigurationManager.AppSettings["BlobContainer"], "LOGO");
        ...
        public async Task<HttpResponseMessage> Post()
        {
            try {
                ...
                if(file != null && file.Headers.ContentType.MediaType.Contains("image"))
                {
                    ...
                    string uniqueBlobName = String.Format("logo_{0}.{1}", userId, file.Headers.ContentType.MediaType.Split('/').Last());
                    ...
                    if (blobs.Any())
                    {
                        ...
                        {
                            if (b.Name.ToUpper().Contains(String.Format("LOGO_{0}", userId).ToUpper()))
                                b.DeleteIfExists();
                        }
                    }
                    ...
                    if (blob.Uri != null && blob.Uri.ToString() != String.Empty)
                    {
                        ...
                        applicationSetting.BrandingSetup = true;
                        applicationSetting.BrandingLogoUrl = uniqueBlobName;
