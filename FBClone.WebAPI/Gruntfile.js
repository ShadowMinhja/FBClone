    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                options: {
                    loadPath: [
                      './assets/bower_components/bourbon/dist'
                    ]
                }
            }
        },
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    expand: true,
                    cwd: 'app/bower_components/simple-line-icons',
                    src: 'fonts/*',
                    dest: '<%= yeoman.dist %>'
                }, {
                    expand: true,
                    ...
                    expand: true,
                    cwd: 'app/bower_components/weather-icons',
                    src: 'font/*',
                    dest: '<%= yeoman.dist %>'
                }, {
                    expand: true,
                    ...
                    expand: true,
                    cwd: 'app/bower_components/leaflet-draw/dist',
                    src: 'images/*',
                    dest: '<%= yeoman.dist %>/styles'
                }, {
                    expand: true,
                    cwd: 'app/bower_components/leaflet/dist',
                    src: 'images/*',
                    dest: '<%= yeoman.dist %>/styles'
                }]
            },
