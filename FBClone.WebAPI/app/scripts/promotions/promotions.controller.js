...
angular.module('fbCloneApp')
    ...
    .controller('PromotionsCtrl', ["$scope", "$state", "$filter", "$modal", "appSettings", "currentUser", "FileUploader", "toastr", "toastrConfig", "promotionsResource", "applicationSettingService", "helpers",
        function ($scope, $state, $filter, $modal, appSettings, currentUser, FileUploader, toastr, toastrConfig, promotionsResource, applicationSettingService, helpers) {
            $scope.page = {
                title: 'My Promotions',
                subtitle: 'Add Your Promotions',
                imageUrl: "/assets/images/promoSample.jpg"
            };
            $scope.myImage = '';
                ...
                if (applicationSettingService.settings == null) {
                    ...
                    applicationSettingService.retrieveSettings().then(function (data) {
                        if (data != null) {
                            ...
                            if (applicationSettingService.settings.promotionSetup == false) {
            ...
            function refreshPromoImage() {
                promotionsResource.getPromoUrl().then(function (data) {
                    if (data != null)
            ...
            function openFirstTimeMessage() {
                ...
                var modalInstance = $modal.open({
                    templateUrl: 'firstTimePromotionEntry.html',
            ...
            uploader.onBeforeUploadItem = function (item) {
                $scope.page.imageUrl = "/app/images/ajax-loader-tall.gif";
            ...
            uploader.onSuccessItem = function (fileItem, response, status, headers) {
                ...
                if (isFirstTime == true) {
                    ...
                    toastr["success"]("Promotional image uploaded succesfully!  Return to this page later if you wish to change it.", "Step 4 Success", {
                        iconClass: 'bg-greensea',
                        iconType: 'fa-check'
                    });
                }
                else {
                    toastr["success"]("Yay! Your promotion was uploaded successfully!", "Promotion Uploaded Successfully!", {
                        iconClass: 'bg-greensea',
                        iconType: 'fa-check'
                    });
                }                
            ...
            uploader.onErrorItem = function (fileItem, response, status, headers) {                
                ...
                {
                    toastr["error"]("Oh no! Something went wrong with the upload. Please try again.", "Promotion Upload Error", {
